...
imageStyles.href = 'css/learning-images.css';
...
const coverImages = {
  web: 'images/learning/generated/web-foundation.jpg',
  java: 'images/learning/generated/java-programming.jpg',
  db: 'images/learning/generated/database-server.jpg',
  spring: 'images/learning/generated/spring-backend.jpg',
  data: 'images/learning/generated/data-ml.jpg',
  ai: 'images/learning/generated/ai-rag.jpg'
};
...
fetch('curriculum.html')
  ...
  .then(html => {
    ...
    section.style.setProperty('--cover', `url('${coverImages[page]}')`);
